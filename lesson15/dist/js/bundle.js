...
/*!************************!*\
  !*** ./src/js/calc.js ***!
  \************************/
/*! exports provided: calc */function(e,o,s){"use strict";s.r(o),s.d(o,"calc",function(){return t});s(/*! core-js/modules/web.dom.iterable */"./node_modules/core-js/modules/web.dom.iterable.js");function t(){var o=document.querySelectorAll(".counter-block-input")[0],s=document.querySelectorAll(".counter-block-input")[1],e=document.querySelectorAll(".counter-block-input"),t=document.getElementById("select"),n=document.getElementById("total"),r=document.querySelector("#select"),u=0,d=0,c=0;n.innerHTML=0,e.forEach(function(o){o.addEventListener("input",function(e){"1234567890".indexOf(e.data,0)<0&&(o.value=o.value.substr(0,o.value.length-1))})}),o.addEventListener("change",function(){u=+this.value,c=d*u*4e3*r.options[r.selectedIndex].value,""==s.value?n.innerHTML=0:n.innerHTML=c}),s.addEventListener("change",function(e){d=+this.value,c=d*u*4e3,""==o.value&&""!=this.value?n.innerHTML=0:n.innerHTML=c,n.innerHTML=c*r.options[r.selectedIndex].value}),t.addEventListener("change",function(){if(""==s.value||""==o.value)n.innerHTML=0;else{var e=c;n.innerHTML=e*this.options[this.selectedIndex].value}})}},"./src/js/form.js":
/*!************************!*\
  !*** ./src/js/form.js ***!
  \************************/
