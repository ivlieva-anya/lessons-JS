...
/*!************************!*\
  !*** ./src/js/form.js ***!
  \************************/
/*! exports provided: Form */function(e,o,s){"use strict";s.r(o),s.d(o,"Form",function(){return t});s(/*! core-js/modules/es6.promise */"./node_modules/core-js/modules/es6.promise.js");function t(){var s,n="Загрузка",r="Спасибо!Скоро мы с вами свяжемся!",u="Что-то пошло не так...",o=document.querySelector(".main-form"),d=o.getElementsByTagName("input"),c=document.createElement("div");c.classList.add("status"),d[0].addEventListener("input",function(e){-1==="0123456789+-)(".indexOf(e.data,0)||16<d[0].value.length?(16<d[0].value.length?c.textContent="Длинна номера не более 16 симв.":c.textContent="Можно вводить только цифры и символы +- ( )",d[0].value=d[0].value.substr(0,d[0].value.length-1),o.appendChild(c)):c.textContent=""}),(s=o).addEventListener("submit",function(e){e.preventDefault(),s.appendChild(c);var t,o=new FormData(s);(t=o,new Promise(function(e,o){var s=new XMLHttpRequest;s.open("POST","server.php"),s.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),s.onreadystatechange=function(){s.readyState<4?c.innerHTML=n:4===s.readyState&&200==s.status?e():o()},s.send(t)})).then(function(){return c.innerHTML=r}).catch(function(){return c.innerHTML=u}).then(function(){return function(){for(var e=0;e<d.length;e++)d[e].value=""}()})})}},"./src/js/index.js":
/*!*************************!*\
  !*** ./src/js/index.js ***!
  \*************************/
